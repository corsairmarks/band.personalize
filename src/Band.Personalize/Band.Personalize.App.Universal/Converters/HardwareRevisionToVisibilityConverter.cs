...
namespace Band.Personalize.App.Universal.Converters
{
    ...
    /// <summary>
    /// Value converter that translates a Band <see cref="HardwareRevision"/> to a <see cref="Visibility"/>.
    /// </summary>
    public class HardwareRevisionToVisibilityConverter : IValueConverter
    {
        ...
        /// <exception cref="ArgumentException"><paramref name="value"/> is not an instance of <see cref="HardwareRevision"/> or <paramref name="targetType"/> is not <see cref="Visibility"/>.</exception>
